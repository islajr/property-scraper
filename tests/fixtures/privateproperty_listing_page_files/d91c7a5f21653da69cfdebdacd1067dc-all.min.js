...
$(".navbar-nav li > a").click(function(){$(".navbar-nav li > a").removeClass("active"),$(this).addClass("active")}),$("button.navbar-toggler").click(function(){$("body").toggleClass("overflow")}),$(".logoSlider").slick({arrows:!1,dots:!1,slidesToShow:4,autoplay:true,autoplaySpeed:3000,responsive:[{breakpoint:991,settings:{slidesToShow:3}},{breakpoint:767,settings:{slidesToShow:2}}]}),$(".featuredImage").slick({arrows:!0,dots:!1,autoplay:!1,slidesToShow:1,prevArrow:'<div class="left-arrow"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="right-arrow"><i class="fas fa-chevron-right"></i></div>',responsive:[{breakpoint:767,settings:{loop: true, arrows: true}}]}),$(".featuredImageDots").slick({arrows:!0,dots:!0,autoplay:!1,slidesToShow:1,prevArrow:'<div class="left-arrow"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="right-arrow"><i class="fas fa-chevron-right"></i></div>',responsive:[{breakpoint:991,settings:{slidesToShow:2}},{breakpoint:767,settings:{slidesToShow:1, loop: true, centerPadding:"40px",arrows:!0,prevArrow:'<div class="left-arrow"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="right-arrow"><i class="fas fa-chevron-right"></i></div>'}}]}),$(".similarSlider").slick({arrows:!1,dots:!0,autoplay:!1,slidesToShow:1}),$(".featuredSlider").slick({arrows:!1,dots:!1,autoplay:!1,slidesToShow:2,responsive:[{breakpoint:991,settings:{slidesToShow:2}},{breakpoint:767,settings:{slidesToShow:1,centerPadding:"80px",arrows:!0,centerMode:!0,prevArrow:'<div class="left-arrow withbg"><i class="fas fa-arrow-left"></i></div>',nextArrow:'<div class="right-arrow withbg"><i class="fas fa-arrow-right"></i></div>'}}]}),$(".searchSlider").slick({arrows:!1,dots:!1,autoplay:!1,slidesToShow:4,responsive:[{breakpoint:991,settings:{slidesToShow:2}},{breakpoint:767,settings:{slidesToShow:1,centerPadding:"80px",arrows:!0,centerMode:!0,prevArrow:'<div class="left-arrow withbg"><i class="fas fa-arrow-left"></i></div>',nextArrow:'<div class="right-arrow withbg"><i class="fas fa-arrow-right"></i></div>'}}]}),$(".neighbourhoodSlider").slick({arrows:!0,dots:!1,autoplay:!1,slidesToShow:4,prevArrow:'<div class="left-arrow withbg"><i class="fas fa-arrow-left"></i></div>',nextArrow:'<div class="right-arrow withbg"><i class="fas fa-arrow-right"></i></div>',responsive:[{breakpoint:991,settings:{slidesToShow:2}},{breakpoint:767,settings:{slidesToShow:1}}]}),$(".projectSlider").slick({adaptiveHeight:true,arrows:!0,dots:!1,autoplay:!1,slidesToShow:1,prevArrow:$(".leftSlick"),nextArrow:$(".rightSlick"),responsive:[{breakpoint:767,settings:{arrows:!1,dots:!0}}]}),$(".projectPropertySlider").slick({arrows:!0,dots:!1,autoplay:!1,slidesToShow:1,prevArrow:$(".leftSlick02"),nextArrow:$(".rightSlick02"),responsive:[{breakpoint:767,settings:{arrows:!1,dots:!0}}]}),$(function(){x=8,$(".amenities-details .amenities-list li").slice(0,8).show(),$(".amenities-details .load-more").on("click",function(i){i.preventDefault(),x+=8,$(".amenities-details .amenities-list li").slice(0,x).slideDown(),$(".amenities-details .load-more").hide()})}),$(function(){y=3,$(".description-property .description-list li").slice(0,3).show(),$(".description-property .load-more").on("click",function(i){i.preventDefault(),y+=3,$(".description-property .description-list li").slice(0,y).slideDown(),$(".description-property .load-more").hide()})}),$(function(){a=6,$(".facilities .facilities-list li").slice(0,6).show(),$(".facilities .load-more").on("click",function(i){i.preventDefault(),a+=6,$(".facilities .facilities-list li").slice(0,a).slideDown(),$(".facilities .load-more").hide()})}),$(function(){c=8,$(".typesNpricess .typesNpricess-list li").slice(0,8).show(),$(".typesNpricess .load-more").on("click",function(i){i.preventDefault(),c+=8,$(".typesNpricess .typesNpricess-list li").slice(0,c).slideDown(),$(".typesNpricess .load-more").hide()})}),$(function(){d=1,$(".full-description .fulldescription-list li").slice(0,1).show(),$(".full-description .load-more").on("click",function(i){i.preventDefault(),d+=3,$(".full-description .fulldescription-list li").slice(0,d).slideDown(),$(".full-description .load-more").hide()})}),$(".moreless-button").click(function(){$(".moretext").slideToggle(),"Read more"==$(".moreless-button").text()?$(this).text("Read less"):$(this).text("Read more")});
$(document).ready(function () {
    /*$('.propertType').multiSelect({
      'noneText':'Type',
    });
    $('.selectBeds').multiSelect({
      'noneText':'Beds',
    });
...
function Show(title, msg) {
    var $content =  "<div class='dialog-ovelay'>" +
        ...
        "<footer>" +
        "<div class='controls'>" +
        " <button class='btn btn-light cancelAction'>Close</button> " +
        "</div>" +
        "</footer>" +
        "</div>" +
        "</div>";
...
$('.property-tabs.project-tabs .nav-tabs .nav-link').click(function(){
    $('.property-tabs.project-tabs .nav-tabs .nav-link').removeClass("active");
    $(this).addClass("active");
});

//

// $(".listings-favorite").click(function(){
//   $(".far").toggleClass("fas");
// });

$(document).ready(function () {
    $('.listings-favorite').bind("click", function() {
        $(this).next().toggleClass('fas');
    })
});
